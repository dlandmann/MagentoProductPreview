...
class Landmann_ProductPreview_Helper_Catalog_Product_View extends Mage_Catalog_Helper_Product_View
{
    /**
    ...
    {
        $productHelper = Mage::helper('landmann_productpreview/catalog_product');
        if (!$params) {
