...
class Landmann_ProductPreview_ProductController extends Mage_Core_Controller_Front_Action
{
    /**
    ...
    public function previewAction()
    {
        ...
        $viewHelper = Mage::helper('landmann_productpreview/catalog_product_view');
